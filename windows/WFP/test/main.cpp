...
int main(int argc, char *argv[])
{
    ...
    inet_pton(AF_INET, "180.101.50.188", &baidu_forbid_rule.remote_addr_info.v4.domain_address[0]);
    inet_pton(AF_INET, "180.101.50.242", &baidu_forbid_rule.remote_addr_info.v4.domain_address[1]);
