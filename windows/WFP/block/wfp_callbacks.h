...
#define NDIS61                                                                 \
  1 // Need to declare this to compile WFP stuff on Win7, I'm not sure why

#pragma warning(push)
#pragma warning(disable : 4201) // Disable "Nameless struct/union" compiler
                                // warning for fwpsk.h only!
